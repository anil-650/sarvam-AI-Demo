  ...
  return (
    <div className='text-center flex justify-center min-h-screen bg-blue-100'>
      <div className='w-md shadow shadow-gray-400 p-8 flex flex-col items-center rounded-2xl'>
        <h1 className='text-2xl text-blue-500 py-5'><b>Text to Speech Converter</b></h1>
       
        <p>API KEY STATUS: {KEY_LOAD_STATUS} </p>
        <p className="mb-2 text-sm text-gray-600">
        <span className="font-semibold">Language:</span> Odia (ଓଡ଼ିଆ)
      </p>
        <p><b>Enter your text below and click "Convert to Speech"</b></p>
